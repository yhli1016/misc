...
def plot_dos_mob(ax1: plt.Axes, config: Config,
                 energy_dos: np.ndarray, dos: np.ndarray,
    ...
    :param ax1: axes on which DOS and carrier density will be plot
...
def main():
    ...
    plot_single(Config(figure_name="dos_mob2.png"), plot_dos_mob,
                energy_dos, dos, energy_dc, mobility)
