...
params = [[qw_width, eps1, eps2, eps3]
          for qw_width in np.linspace(15, 300, 10).tolist()
          for eps1 in np.linspace(1, 10, 10).tolist()
          for eps2 in [3.74352665]
          for eps3 in [1.0]]
x0 = 1.0
for param in params:
    ...
    if rank == 0:
        ...
        print("%12.6f%12.6f%12.6f%12.6f%12.6f" %
              (qw_width_nm, eps1, eps2, a_nm, eb_meV), flush=True)
    x0 = xopt[0]
